...
draw_rectangle("ivory", 100, 100, 200, 200)
draw_rectangle("lavender", -100, 100, 200, 200)
draw_rectangle("lavender", 100, -100, 200, 200)
draw_rectangle("ivory", -100, -100, 200, 200)
# snoopy is amazing
s1 = create_sprite("snoopy2", 100, 100)
s2 = create_sprite("skates2", -100, -100)
s3 = create_sprite("spotify", -100, 100) 
s4 = create_sprite("books2", 100, -100)

# I wasn't sure what to write for my message
message1 = create_sprite("alien",-200,200)
message1.color("blue")
message1.write("Amelia",font = ("Arial", 40, "normal"))
message1.hideturtle()
message2 = create_sprite("alien", 0, -255)
message2.color("blue")
